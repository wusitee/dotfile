...
(doom! :input
       ...
       ;;(emoji +unicode)  ; 🙂
       hl-todo           ; highlight TODO/FIXME/NOTE/DEPRECATED/HACK/REVIEW/BUG
       ;;hydra
       ...
       ;; rgb               ; creating color strings (deprecated)
       ...
       ;;(dart +frutter)   ; paint ui and not much else
       ;;dhall
       ...
       (org +gnuplot +journal +jupyter +noter +present +dragndrop +roam2)            ; organize your plain life in plain text
