...
#+end_src
In addition to that, using the script in dotfiles-huawei-wmi to make the threshold works after suspension.
** microcode
...
#+begin_src shell
yay -S fcitx5-im fcitx-rime rime-ice-git ttf-hanamin
#+end_src
