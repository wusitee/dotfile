...
(setq doom-font (font-spec :family "Maple Mono Normal NF CN" :size 15))
#+end_src
** Transparency
...
(after! gptel
  (setq
   ...
   gptel-backend (gptel-make-gemini "Gemini"
                   :key
                   (let ((found (auth-source-search :host "gemini" :user "apikey")))
                     (if found
                         (funcall (plist-get (car found) :secret))
                       (error "No authentication entry found for vveai.com with user apikey")))
...
(use-package! claude-code-ide
  ...
  (map! :leader
        :prefix ("c" . "code")
        :desc "Claude Code IDE" "'" #'claude-code-ide-menu))
#+end_src
...
#+begin_src emacs-lisp :tangle yes
;; (add-to-list 'load-path "/home/wste/code/emacs-chinese-word-segmentation")
;; (setq cns-prog "/home/wste/code/emacs-chinese-word-segmentation/cnws")
;; (setq cns-dict-directory "/home/wste/code/emacs-chinese-word-segmentation/cppjieba/dict")
...
#+end_src
*** org agenda files
Add research todo and schedule files to org agenda.
#+begin_src emacs-lisp
(after! org
  (add-to-list 'org-agenda-files "~/research/todo.org")
  (add-to-list 'org-agenda-files "~/research/plan/schedule.org")
  (add-to-list 'org-agenda-files "~/research/papers/papers.org"))
#+end_src
*** org super agenda
Group agenda items into sections for better scannability.
#+begin_src emacs-lisp
(use-package! org-super-agenda
  :after org-agenda)
#+end_src
*** org agenda cleanup
Keep dated TODO entries out of the lower global TODO list.
#+begin_src emacs-lisp :tangle yes
(after! org
  (setq org-agenda-custom-commands
        '(("n" "Agenda and de-duplicated TODOs"
           ((agenda "")
            (alltodo ""
...
*** uv
#+begin_src emacs-lisp :tangle no
(add-hook! 'python-mode 'uv-edit-pyproject-toml)
#+end_src
